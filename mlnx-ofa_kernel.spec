...
%{!?_version: %global _version 24.04}
%{!?_release: %global _release OFED.24.04.0.6.6.1}
...
Utilities rpm.
The driver sources are located at: http://www.mellanox.com/downloads/ofed/mlnx-ofa_kernel-24.04-0.6.6.tgz
