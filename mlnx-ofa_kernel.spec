...
%{!?_version: %global _version 24.01}
%{!?_release: %global _release OFED.24.01.0.3.3.1}
...
Utilities rpm.
The driver sources are located at: http://www.mellanox.com/downloads/ofed/mlnx-ofa_kernel-24.01-0.3.3.tgz
