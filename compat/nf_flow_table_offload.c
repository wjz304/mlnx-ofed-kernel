...
static inline struct flow_rule *flow_rule_alloc(unsigned int num_actions)
{
...
static void nf_flow_offload_init(struct flow_cls_offload1 *cls_flow,
...
{
	struct flow_cls_offload1 cls_flow = {};
...
EXPORT_SYMBOL_GPL(nf_flow_table_offload_init);

void nf_flow_table_offload_exit(void)
{
	destroy_workqueue(nf_flow_offload_wq);
}
EXPORT_SYMBOL_GPL(nf_flow_table_offload_exit);
